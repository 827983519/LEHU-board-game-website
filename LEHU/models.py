...
class User(models.Model):
    ...
    user_nickname = models.CharField(verbose_name='Nickname',max_length = 20)
    ...
    user_email = models.CharField(verbose_name='Email',max_length = 20)

    '''
    user_birthday = models.DateField(verbose_name='Birthday', null=True)
    user_image = models.ImageField(upload_to=u'image/%Y/%m', default=u"image/default.png", max_length=100,null=True, blank=True)
    user_province = models.CharField(verbose_name='Province',max_length = 20)
    user_city = models.CharField(verbose_name='City',max_length = 20)
    user_address = models.CharField(verbose_name='Address',max_length = 20)
    user_postcode = models.CharField(verbose_name='Postcode',max_length = 6)
    '''
    #user_email = models.CharField(max_length=11, verbose_name=u"手机号码", null=True, blank=True)
    def __str__(self):
